...
namespace RepositoryOfVehicle.Business.Constants
{
   public static class Messages
    {
        ...
        public static string SuccessHeadlights = "Headlights are on";
        public static string ErrorHeadlights = "Headlights are off";
